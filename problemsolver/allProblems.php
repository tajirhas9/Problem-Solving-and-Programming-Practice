	...
	<div id = "contest_content" style = "padding : 13%;">
		<?php
			...
			if($contestStart == false)
			{
				...
				$sql = "SELECT serial_number,problemNumber,problemName FROM contestProblem;";
				$query =  mysqli_query($conn,$sql);
				echo "<table>";
				echo 	"<tr>";
				echo 		"<th>No.</th>";
				echo		"<th>Problem Catagory</th>";
				...
				while($info = mysqli_fetch_array($query))
				{
					...
					echo "<tr>";
					echo 	"<td align = 'center'><a href = 'problemOnContest.php?problemSerial=$problemSerial'>".$i."</a></td>";
					echo 	"<td align = 'center'><a href ='problemOnContest.php?problemSerial=$problemSerial'>".$problemNumber."</a></td>";
					echo 	"<td><a href = 'problemOnContest.php?problemSerial=$problemSerial'>".$problemName."</a></td>";
					echo "</tr>";
					$i++;
				}
				echo "</table>";
			...
			{
				echo "Problems are currently availabe due to current contest.Please participate in the contest.";
			}
		?>
	</div>
